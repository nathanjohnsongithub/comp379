To run the code you will need `pandas` and the `train.csv` file from kaggle. If you don't want to run the code the output is below while running `hw1.py` with `train.csv`.
